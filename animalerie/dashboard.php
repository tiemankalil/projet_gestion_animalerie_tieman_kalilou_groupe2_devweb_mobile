...
<html lang="en">
  ...
  <div class="container">
     ...
     $requete = 'SELECT * FROM animaux ORDER BY reference DESC';
     ...
     ?>
                <tr>
                    ...
                    <td><?php echo $row['fourrure']?></td>
                    <td>
                        <a name="modifier" id="" class="btn btn-primary" href="tableau.php?id=<?php echo $row['reference']?>" role="button">Modifier</a>
                    </td>
                    <td>
                        <a name="supprimer" id="" class="btn btn-danger" href="tableau.php?id=<?php echo $row['reference']?>" role="button">Supprimer</a>
                    </td>
